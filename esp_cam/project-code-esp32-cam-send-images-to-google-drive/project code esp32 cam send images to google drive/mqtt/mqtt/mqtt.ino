...
//#define MQTT_USER               "khurram"
//#define MQTT_PASSWORD           "SCL123"
#define MQTT_PUBLISH_TOPIC    "Agriculture/smartcity/device-1/send"
#define MQTT_SUBSCRIBE_TOPIC  "Agriculture/smartcity/device-1/get"
    
WiFiClient espClient;
PubSubClient client(espClient);

//Arduino IDE Development version selection ESP32 Wrover Module

//ESP32-CAM Anxin can module pin setting
...
//Customize command parameter values
String command="";
String cmd="";
String P1="";
String P2="";
...
//Custom command disassembly status value
byte receiveState=0;
byte cmdState=1;
byte pState=1;
