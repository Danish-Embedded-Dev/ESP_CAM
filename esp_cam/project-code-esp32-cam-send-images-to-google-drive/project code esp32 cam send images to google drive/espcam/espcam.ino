...
const char* ssid     = "Extensity";   //your network SSID
const char* password = "password";   //your network password 
String myScript = "/macros/s/AKfycbz5ArqLcliibW-rCCQ2u-yS5ytqPO0Cv0r30NxGKtg2lxrg2RSPRyXQ_wlKxSJ6gqsmAA/exec";    //Create your Google Apps Script and replace the "myScript" path.
