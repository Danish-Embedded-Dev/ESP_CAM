...
//輸入WIFI連線帳號密碼
const char* ssid     = "JADUR";   //your network SSID
const char* password = "jadur19677";   //your network password

String myToken = "5519401489:AAFsK5kF-hzgnGn-iqZyls31Hn3ryJAF9Bk";   // Create your bot and get the token -> https://telegram.me/fatherbot
String myChatId = "5510245055";   // Get chat_id -> https://telegram.me/userinfobot
